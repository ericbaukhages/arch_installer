...
# copied from: https://github.com/Phantas0s/mouseless-book-companion/blob/69e17814a20077fc9bb208b8347fb71341e6e13f/part_III/02_installing_arch_linux/arch_installer/install_sys.sh
...
curl https://raw.githubusercontent.com/ericbaukhages\
